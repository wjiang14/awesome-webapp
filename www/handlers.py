...
from apis import Page, APIValueError, APIError, APIResourceNotFoundError
...
def user2cookie(user, max_age):
    ...
    # build cookie string buy: id-expires-sha1
...
def authenticate(*, email, passwd):
    ...
    user.passwd = '******'
    r.content_type = 'appliation/json'
